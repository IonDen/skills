...
- **writing-tests-that-can-fail** keeps tests real in any language: real behaviour, every condition covered, and a failure on the bug each test exists to catch.
